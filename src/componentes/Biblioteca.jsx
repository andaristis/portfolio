...
import fondoInicio from '../img/fondo_home.jpg'
import logoAndaristis from '../img/svg/logo_andaristis.svg'
import logoTerrarent from '../img/svg/terraRent_svg.svg'
import logoCortal from '../img/svg/cortal.svg'
import logoReact from '../img/svg/react_svg.svg'
import logoScrum from '../img/svg/scrum_svg.svg'
import logoTrello from '../img/svg/trello_svg.svg'
import logoJS from '../img/svg/js_svg.svg'
import logoCSS from '../img/svg/css_svg.svg'
import logoHTML from '../img/svg/html_svg.svg'
import logoGit from '../img/svg/git_svg.svg'
import previewTerrarent from '../img/preview_terrarent.png'
import previewCortal from '../img/preview_cortal.png'
import logoReactAzul from '../img/svg/svg_azul/react_svg.svg'
import logoScrumAzul from '../img/svg/svg_azul/scrum_svg.svg'
import logoTrelloAzul from '../img/svg/svg_azul/trello_svg.svg'
import logoJSAzul from '../img/svg/svg_azul/js_svg.svg'
import logoCSSAzul from '../img/svg/svg_azul/css_svg.svg'
import logoHTMLAzul from '../img/svg/svg_azul/html_svg.svg'
import logoGitAzul from '../img/svg/svg_azul/git_svg.svg'
import logoFigmaAzul from '../img/svg/svg_azul/figma_svg.svg'
import logoIdiomaAzul from '../img/svg/svg_azul/idioma_svg.svg'
import logoCorelAzul from '../img/svg/svg_azul/corel_svg.svg'
import logoTestingAzul from '../img/svg/svg_azul/testing_svg_azul.svg'
import logoExcelAzul from '../img/svg/svg_azul/excel_svg.svg'
import logoMySqlAzul from '../img/svg/svg_azul/mysql_svg.svg'
import logoAwsAzul from '../img/svg/svg_azul/aws_svg.svg'
import logoPostmanAzul from '../img/svg/svg_azul/postman_svg.svg'
import logoJavaAzul from '../img/svg/svg_azul/java_svg.svg'
import logoIllustartorAzul from '../img/svg/svg_azul/illustrator_svg.svg'
import logoPhotoshopAzul from '../img/svg/svg_azul/ps_svg.svg'
import logoAgileAzul from '../img/svg/svg_azul/agile_svg.svg'
import fotoPersonal from '../img/foto_personal.png'
import logoInstagram from '../img/svg/instagram_svg.svg'
import logoLinkedin from '../img/svg/linkedin_svg.svg'
import logoWhatsapp from '../img/svg/whatsapp_svg.svg'
import logoTelefono from '../img/svg/telefono_svg.svg'
import logoGmail from '../img/svg/gmail_svg.svg'
...
const Biblioteca = () => {
    const images = {
        ...
        contactos:[
                ...
                nombre:"linkedin",
                logo: logoLinkedin,
                texto: "https://www.linkedin.com/in/andaristis/"},
                {id:3,
                nombre:"telefono",
                logo: logoTelefono,
    ...
    const habilidades = [
            ...
            descripcion: "Experiencia sólida en el diseño de interfaces de usuario y creación de prototipos interactivos. Utilizo las  herramientas de diseño de Figma para crear diseños limpios y modernos, centrándome en usabilidad y accesibilidad.",
            },
            {id: 9,
            titulo: "COREL DRAW",
